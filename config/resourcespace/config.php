...
$ffmpeg_alternatives[0]["params"] = "-threads 1 -vcodec libx264 -preset slow -vprofile main -pix_fmt yuv420p -vf yadif -crf 22 -s 800x600 -x264opts threads=1 -acodec libfdk_aac -ac 2 -ab 128k";
...
$ffmpeg_alternatives[2]["params"] = "-threads 1 -b:v 300k  -level 13 -vcodec libx264 -preset slow -vprofile baseline -pix_fmt yuv420p -s 256x144 -crf 20 -x264opts threads=1 -acodec libfdk_aac -ac 2 -ab 64k -ar 22050";
